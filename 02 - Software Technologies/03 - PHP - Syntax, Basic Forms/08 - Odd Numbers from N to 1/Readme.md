<OL START=8>
	<LI><H2 CLASS="western">Odd Numbers from N to 1</H2>
</OL>
...
to<FONT FACE="Consolas, serif"><B> 1</B></FONT> and prints only the
odd ones. The input comes as a parameter named <FONT FACE="Consolas, serif"><B>num</B></FONT>.
...
<TABLE WIDTH=383 CELLPADDING=4 CELLSPACING=0>
	...
	<TR>
		...
		<TD WIDTH=54 STYLE="border: 1px solid #00000a; padding-top: 0.04in; padding-bottom: 0.04in; padding-left: 0.06in; padding-right: 0.06in">
			<P><FONT FACE="Consolas, serif">5 3 1</FONT></P>
		</TD>
