<OL START=7>
	<LI><H2 CLASS="western">Even Numbers from 1 to N</H2>
</OL>
<P STYLE="margin-top: 0.06in">You are given a number <FONT FACE="Consolas, serif"><B>num</B></FONT>.
Write a PHP script that loops through all of the numbers from <FONT FACE="Consolas, serif"><B>1</B></FONT>
to<FONT FACE="Consolas, serif"><B> num</B></FONT> and prints only the
even ones. The input comes as a parameter named <FONT FACE="Consolas, serif"><B>num</B></FONT>.
The parameter <FONT FACE="Consolas, serif"><B>num</B></FONT> will
hold a positive integer.</P>
<H3 CLASS="western">Examples</H3>
<TABLE WIDTH=383 CELLPADDING=4 CELLSPACING=0>
	<COL WIDTH=108>
	<COL WIDTH=53>
	<COL WIDTH=54>
	<COL WIDTH=12>
	...
	<TR>
		...
		<TD WIDTH=54 STYLE="border: 1px solid #00000a; padding-top: 0.04in; padding-bottom: 0.04in; padding-left: 0.06in; padding-right: 0.06in">
			<P><FONT FACE="Consolas, serif">2 4</FONT></P>
		</TD>
